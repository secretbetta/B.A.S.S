...
public class HelpCmds {
	...
	public static List<EmbedBuilder> helpCmds() {
		...
		eb = new EmbedBuilder()
		    ...
		    .setThumbnail("http://www.handandbeak.com/wp-content/uploads/ju/jumping-bass-fish-icon-vector.jpg") // Use BASS Icon
		    .addField("~~help", "Lists all possible commands", false)
		    .addField("~~leaderboard <Player1> <Player2>", "Shows leaderboard. Player flags are optional to print scores between two people", false)
		...
		eb = new EmbedBuilder()
			    ...
			    .addField("~~move <1-9>", "Where to place your move, 1-9 from top left to bottom right", false)
